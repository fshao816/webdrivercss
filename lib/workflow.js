...
module.exports = function(id, args) {
    ...
    var filename = args.filename || id + '.current.png',
        filenameNew = args.filename || id + '.new.png',
        filenameDiff = args.filename || id + '.diff.png';
    ...
    var context = {
        ...
        args:            args,
        cb:              cb,
        filename:        this.screenshotTarget + '/' + filename,
        filenameCurrent: this.screenshotTarget + '/' + filename,
        filenameNew:     this.screenshotRoot + '/' + filenameNew,
        filenameDiff:    this.failedComparisonsRoot + '/' + filenameDiff,
