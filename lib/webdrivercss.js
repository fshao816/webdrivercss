...
var WebdriverCSS = function(webdriverInstance, options) {
     ...
     * general options
     */
    this.screenshotRoot = options.screenshotRoot || 'webdrivercss/screens';
    this.failedComparisonsRoot = options.failedComparisonsRoot || 'webdrivercss/diff';
    this.misMatchTolerance = options.misMatchTolerance || 0.05;
    this.screenWidth = options.screenWidth;
    this.warning = [];
    this.instance = webdriverInstance;

    this.screenshotTarget = options.screenshotTarget || 'webdrivercss/targets';
    this.saveEverything = options.saveEverything || false;
